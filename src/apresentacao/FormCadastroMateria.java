...
public class FormCadastroMateria extends javax.swing.JInternalFrame {
    ...
    private void jTableMateriaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableMateriaMouseClicked
        // TODO add your handling code here:
        jTextId.setText(jTableMateria.getValueAt(
                jTableMateria.getSelectedRow(),0).toString());
        jTextNome.setText(jTableMateria.getValueAt(
                jTableMateria.getSelectedRow(),1).toString());
        jTextAreaDescricao.setText( jTableMateria.getValueAt(
                jTableMateria.getSelectedRow(),3).toString());
        jTextHorasAula.setText( jTableMateria.getValueAt(
                jTableMateria.getSelectedRow(),2).toString());
        jTextId.setEditable(false);
